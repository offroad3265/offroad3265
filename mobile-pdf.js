...
async function startViewer() {
  try {
    const pdfjsLib = await import("https://cdn.jsdelivr.net/npm/pdfjs-dist@6.3.289/build/pdf.min.mjs");
    ...
    const { EventBus, PDFLinkService, PDFViewer } =
      await import("https://cdn.jsdelivr.net/npm/pdfjs-dist@6.3.289/web/pdf_viewer.mjs");
    ...
    status.textContent = "Le lecteur n’a pas pu charger le document.";
  }
}
